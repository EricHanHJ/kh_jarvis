...
<div data-role="page" id="fw_dnat">
	...
	<div role="main" class="ui-content">
		...
		function sbmt(mode){
			if(mode == "add"){
				iptb.action = "firewall_dnat_insert.php";
			} else if(mode == "delete"){
				iptb.action = "firewall_dnat_delete.php";
			}
			iptb.submit();
		}
		</script>
		...
		<form name="iptb" method="POST">
			<div class="ui-grid-d">
				...
				<div class="ui-block-c"><input name="exip2" type="text" maxlength="3" data-mini="true" data-clear-btn="true"></div>
				<div class="ui-block-d"><input name="exip3" type="text" maxlength="3" data-mini="true" data-clear-btn="true"></div>
				<div class="ui-block-e"><input name="exip4" type="text" maxlength="3" data-mini="true" data-clear-btn="true"></div>
			</div><!-- /grid-d -->
		...
		<table class="ui-responsive table-stroke" id="table-column-toggle" data-role="table" >
			...
			<tbody>
				...
				while($result=mysql_fetch_array($return)){
					...
					echo "<th>".$result['inip']."/".$result['inmask']."</th>";
					echo "</tr>";
				}
				mysql_close($conn);
				?>
